                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    ...
                                                    <button class="btn btn-primary d-none d-md-inline-flex" name="search" type="submit">Cari</button>
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            <a href="#" class="btn btn-icon btn-primary d-md-none"><em class="icon ni ni-plus"></em></a>
                                                            <a href="v_tambah_pengguna.php" class="btn btn-primary d-none d-md-inline-flex"><span>Tambah Akun</span></a> 
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="nk-block">
                                    <div class="nk-tb-list is-separate is-medium mb-3">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col" style="width: 300px; text-align: center;"><span>Username</span></div>
                                            <div class="nk-tb-col" style="width: 300px; text-align: center;"><span>Outlet</span></div>
                                            <div class="nk-tb-col tb-col-md" style="width: 400px; text-align: center;"><span>Role</span></div>
...
if (!$perintah->tampil_data()) {
    ...
    <a href="v_pengguna.php"><button type="button" class="btn-close" aria-label="Close alert"></button></a>
      <div class="d-flex">
...
?>
                                        <div class="nk-tb-item">
                                            ...
                                            <span class="tb-sub" style=" text-align: center;"><?php echo $data->username ?></span>
                                            </div>
                                            ...
                                            <div class="nk-tb-col" style=" text-align: center;">
                                                ...
                                                <?php if ($data->role == 'admin') {
                                                    echo '<span class="badge badge-sm badge-dot has-bg bg-warning d-none d-sm-inline-flex" >Admin</span>';
                                                } else if ($data->role == 'kasir') {
                                                    echo '<span class="badge badge-sm badge-dot has-bg bg-success d-none d-sm-inline-flex" >Kasir</span>';
                                                } else if ($data->role == 'owner') {
                                                    echo '<span class="badge badge-sm badge-dot has-bg bg-danger d-none d-sm-inline-flex" >Owner</span>';
                                                }
                                                ?>
                                            </div>
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <li class="nk-tb-action-hidden"><a href="v_edit_pengguna.php?id=<?php echo $data->id ?>" class="btn btn-icon btn-trigger btn-tooltip" title="Edit">
                                                            <em class="icon ni ni-pen2"></em></a></li>
                                                    <li class="nk-tb-action-hidden"><a href="../../routers/r_pengguna.php?id=<?php echo $data->id ?>&aksi=hapus" class="btn btn-delete btn-icon btn-trigger btn-tooltip" title="Delete">
    ...
    if (isset($_POST['search'])) {
        ...
        if ($page-1) {
            echo "<li class='page-item'><a class='page-link' href=\"v_pengguna.php?page=".($page-1)."\"><em class='icon ni ni-chevrons-left'></em></a></li>";
         }
       ...
       for($x=1; $x<=$halm; $x++){
           if($x != $page) {
            ...
            {
                echo "<li class='page-item'><a class='page-link' href=\"v_pengguna.php?page=$x\">$x</a></li>";
            }
           } else {
            echo "<li class='page-item active'><a class='page-link' href=\"v_pengguna.php?page=$x\">$x<span class='sr-only'></span></a></li>";
           }
       }
       if ($page!=$halm) {
           echo "<li class='page-item'><a class='page-link' href=\"v_pengguna.php?page=".($page+1)."\"><em class='icon ni ni-chevrons-right'></em></a></li>";
        }
    }
}
    ?>

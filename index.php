...
<head>
  ...
  <!-- Favicons -->
  <link rel="shortcut icon" href="assets/images/S.ico">
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-6 pt-5 pt-lg-0">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
              SevenLaundry merupakan salah satu pelayanan jasa di bidang cuci mencuci pakaian dengan memiliki jenis cucian yang telah ditetapkan harga oleh pihak Kami
            </p>
            <div class="row">
        ...
        <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
          ...
          <li>
            ...
            <div id="faq2" class="collapse" data-bs-parent=".faq-list">
              <p>
                Anda bisa Datang ke Seven Laundry Untuk Mendaftarkan Pesanan Cucian Kepada kami yang akan kami proses secara cepat!
              </p>
            </div>
          </li>

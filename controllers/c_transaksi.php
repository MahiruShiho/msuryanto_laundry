...
class c_transaksi{
    public function koneksi(){
        $conn = mysqli_connect("localhost", "root", "shiho233211", "laundry");
    ...
    public function cetak(){
        ...
        public function insert_data2($id, $outlet, $invoice, $member, $tgl, $batass, $status, $dibayar, $user, $produk, $qty, $keterangan){
            ...
            $query = "INSERT INTO `tb_transaksi` (`id`, `id_outlet`, `kode_invoice`, `id_member`, `tgl`, `batas_waktu`, `tanggal_bayar`, `biaya_tambahan`, `diskon`, `pajak`, `status`, `dibayar`, `id_user`, `id_paket`, `qty`, `keterangan`) VALUES (NULL, '$outlet', '$invoice', '$member', '$tgl', '$batass', '0000-00-00', '0', '0', '0', '$status', '$dibayar', '$user', '$produk', '$qty', '$keterangan');";
